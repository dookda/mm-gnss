...
let changeColorMarker = (id, val) => {
    ...
    id == 'sta005' ? staLatlon = [18.348869, 99.699504] : null;
    id == 'sta006' ? staLatlon = [18.357983, 99.702851] : null;
    id == 'sta007' ? staLatlon = [18.367473, 99.713365] : null;
    id == 'sta008' ? staLatlon = [18.364072, 99.715371] : null;
    id == 'sta009' ? staLatlon = [18.383051, 99.721390] : null;
    id == 'sta010' ? staLatlon = [18.387062, 99.724952] : null;
